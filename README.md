...
<p align="center">
  ...
  <a href="https://www.typescriptlang.org/"><img src="https://img.shields.io/badge/TypeScript-5.8-3178C6?style=for-the-badge&logo=typescript&logoColor=white" alt="TypeScript 5" /></a>
...
```mermaid
graph LR
    A[Enter Your Name] --> B[Pick / Customize Quote]
    B --> C[Select Theme & Dimensions]
    C --> D[Live Real-time Preview]
    D --> E[Export High-DPI PNG]
    D --> F[Share via WhatsApp / QR Code]
    D --> G[Save to Wall of Wishes]
```
